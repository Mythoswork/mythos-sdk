...
export default function CopyButton({className}: Props): ReactNode {
  ...
  return (
    <Button
      ...
      {/* The Figma labels this control rather than relying on the icon alone.
          aria-label above already carries the accessible name, so the text is
          marked decorative to avoid announcing it twice. */}
      <span className="mythos-code__copy-label" aria-hidden="true">
