...
This is a real bug the Python mock app shipped and then fixed (see [commit `c791b53`](https://github.com/Mythoswork/mythos-sdk-python-mock-integration-app/commit/c791b53)):
