...
* [Quickstart: Node.js](getting-started/quickstart-node.md)
...
* [Vercel serverless](guides/vercel-serverless.md)

## API reference — Node.js

* [Overview](reference/node/overview.md)
* [handshakeRoute](reference/node/handshake-route.md)
* [listingCallbackRoute](reference/node/listing-callback-route.md)
* [requireLaunchToken](reference/node/require-launch-token.md)
* [verifyLaunchToken](reference/node/verify-launch-token.md)
* [reportUsage](reference/node/report-usage.md)
* [Errors](reference/node/errors.md)
* [Configuration](reference/node/configuration.md)

## API reference — Python

* [Overview](reference/python/overview.md)
* [handshake_router](reference/python/handshake-router.md)
* [create_listing_callback_handler](reference/python/create-listing-callback-handler.md)
* [require_launch_token](reference/python/require-launch-token.md)
* [verify_launch_token](reference/python/verify-launch-token.md)
* [report_usage](reference/python/report-usage.md)
* [Errors](reference/python/errors.md)
